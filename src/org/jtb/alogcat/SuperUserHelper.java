 ...
 *
 * Copied from the catlog Android application
 * Source: https://github.com/nolanlawson/Catlog
 */
public class SuperUserHelper {

    public static final String TAG = "SuperUserHelper";
	...
	private static List<Integer> getAllRelatedPids(final int pid) {
        ...
        try {
            ...
            Log.e(TAG, "cannot get process ids", e1);
        }
	...
	public static void destroy(Process process) {
	    ...
	    Log.d(TAG, String.format("Killing %s", allRelatedPids));
	...
	private static void destroyPid(int pid) {
        ...
        try {
            ...
            Log.e(TAG, "cannot kill process " + pid, e);
        } finally {
            if (outputStream != null) {
                outputStream.close();
            }
	...
	public static boolean hasFailedToObtainRoot() {
		return failedToObtainRoot;
	}
}
